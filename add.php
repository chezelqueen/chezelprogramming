...
if(isset($_POST['Submit'])) {	
	...
	if(empty($fname) || empty($lname) || empty($gender) || empty($birthdate) || empty($address) || empty($contact)) {
		...
		$sql = "INSERT INTO chezel.costumers(fname, lname, gender, birthdate, address, contact) VALUES(:fname, :lname, :gender, :birthdate, :address, :contact)";
		...
		echo "
		<center><font color='green'><a>Data added successfully.</a></center>
		<center><a href='index.php'>View Result</a></center>
